...
?>
								...
								<div class="col-lg-12">
									<div class="jumbotron">
										<h1 class="text-center">
											<img class="img-circle" alt="140x140" style="width: 140px; height: 140px; text-align: center;" src="images/G21_logo.png" data-holder-rendered="true">
												<br>G21 example code
      ...
      CA, 91308-4075, US
																																		...
																																		<div class="row">
																																			<div class="col-xs-2">
																																				<img class="img-circle" src="images/32X32.gif" alt="">
																																				</div>
																																				<div class="col-xs-2">
																																					<img class="img-circle" src="images/32X32.gif" alt="">
																																					</div>
																																					...
																																					<div class="col-lg-4 col-md-6 col-sm-6">
																																						...
																																						<div class="media">
																																							<div class="media-left">
																																								<a href="#">
																																									<img class="media-object" src="images/35X35.gif" alt="...">
																																									</a>
																																								</div>
