...
INSERT INTO `FeedbackTable` (`feedbackID`, `sessionID`, `feedback`) VALUES
...
INSERT INTO `MenteeTable` (`menteeID`, `firstName`, `lastName`, `email`, `gender`, `yrLevel`, `houseID`) VALUES
(1, 'Jo', 'Smith', 's1234@citipointe.qld.edu.au', 'M', 9, 2);
...
INSERT INTO `MentorTable` (`mentorID`, `firstName`, `lastName`, `email`, `gender`, `yrLevel`, `houseID`) VALUES
(1, 'Jill', 'Jack', 's2345@citipointe.qld.edu.au', 'F', 11, 2);
...
INSERT INTO `SessionsTable` (`sessionID`, `date`, `mentorID`, `menteeID`, `subjectID`, `teacherID`) VALUES
