...
<div class="container">
  <div class="row">
      ...
      <p><?php
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				echo "Mentee id: " . $row["menteeID"]. "<br> Name: " . $row["firstName"]. " " . $row["lastName"]. "<br> Email: " . $row["email"] . "<br> Year: " . $row["yrLevel"] . "<br> House: " . $row["houseID"] . "<br><br>";
			}
		} else {
			echo "0 results";
		}
    ...
    <div class="text-center col-sm-6">
		  ...
		  <?php
			...
			if (mysqli_num_rows($result) > 0) {
				...
				while($row = mysqli_fetch_assoc($result)) {
					echo "Mentor id: " . $row["mentorID"]. "<br> Name: " . $row["firstName"]. " " . $row["lastName"]. "<br> Email: " . $row["email"] . "<br> Year: " . $row["yrLevel"] . "<br> House: " . $row["houseID"] . "<br><br>";
				}
			} else {
				echo "0 results";
			}
      ...
      <a class="btn btn-info btn-lg" href="#" role="button">Mentor</a></div>
  </div>
</div>
<hr>
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-sm-6">
      <div class="panel panel-default panel-success"> 
        ...
        <form action="../../../Website/G21_example/bookedSession.php" name="bookSession" method="post">
          ...
          <tbody>
            <tr>
				...
				<option value="houseID" id="1">Asher</option>
					...
					<option value="houseID" id="4">Levi</option></select></th>
            </tr>
            <tr>
            ...
            <tr>
				...
				<option value="mentorID" id="1">Jill Jack</option>
					...
					<option value="mentorID" id="4">Daniel Lee</option></select></th>
            </tr>
            <tr>
              <th scope="row" colspan="2"><p class="text-center"><input type="submit" value="Book Now"   class="btn-success btn"></p></th>
            </tr>
          </tbody>
        </table>
        </form>
